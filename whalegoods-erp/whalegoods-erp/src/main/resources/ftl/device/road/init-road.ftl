...
<div class="x-body">
  <form class="layui-form layui-form-pane" style="margin: 20px;">
    <div class="layui-form-item">
      <fieldset class="layui-elem-field layui-field-title" style="margin-top: 10px;"><legend style="font-size:16px;">初始化信息</legend></fieldset>
    </div>
    <div class="layui-form-item">
     <!--设备-->
    ...
    <span style="color:red;">注意</span>：初始化货道会将对应设备已有的货道全部清空
  <div style="width: 100%;height: 55px;background-color: white;border-top:1px solid #e6e6e6; position: fixed;bottom: 1px;margin-left:-20px;">
    <div class="layui-form-item" style=" float: right;margin-right: 30px;margin-top: 8px">
      <button  class="layui-btn layui-btn-normal" lay-filter="init" lay-submit="">初始化</button>
