...
<div class="x-body">
  <form class="layui-form layui-form-pane" style="margin-left: 20px;">
    ...
    <!-- 商品编码 -->
    <div class="layui-form-item">
    <input type="hidden" id="hidPicUrl" name="picUrl" value="" />
    ...
    <label for="goodsName" class="layui-form-label"><span class="x-red">*</span>中文品名</label>
      <div class="layui-input-inline"><input type="text"  id="goodsName" name="goodsName"  lay-verify="required" autocomplete="off" class="layui-input"></div>
    </div>
    <div class="layui-inline">
    <!--英文品名-->
      <label for="goodsNameEn" class="layui-form-label">英文品名</label>
      <div class="layui-input-inline"><input type="text"  id="goodsNameEn" name="goodsNameEn"  autocomplete="off" class="layui-input"></div>
       </div>
    </div>
    ...
    <div class="layui-form-item">
     ...
     <label for="spec" class="layui-form-label">商品规格</label>
      <div class="layui-input-inline"><input type="text"  id="spec" name="spec"  autocomplete="off" class="layui-input"></div>
     </div>
     <div class="layui-inline">
     <!--箱包装数-->
     <label for="boxNum" class="layui-form-label"><span class="x-red">*</span>箱包装数</label>
      <div class="layui-input-inline"><input type="text"  id="boxNum" name="boxNum" lay-verify="required|number"  autocomplete="off" class="layui-input"></div>
     </div>
    </div>
    ...
    <div class="layui-inline">
     ...
     <label for="productDate" class="layui-form-label"><span class="x-red">*</span>生产日期</label>
      <div class="layui-input-inline"><input type="text"  id="productDate" name="productDate" placeholder="年-月-日" lay-verify="required|date"  autocomplete="off" class="layui-input"></div>
    </div>
    <div class="layui-inline">
     <!--保质期，按月数-->
     <label for="shelfLife" class="layui-form-label"><span class="x-red">*</span>保质期</label>
      <div class="layui-input-inline"><input type="text"  id="shelfLife" name="shelfLife" lay-verify="required|number|shelfLife"  autocomplete="off" class="layui-input"></div>
    </div>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline"><input type="text"  id="madeIn" name="madeIn"  autocomplete="off" class="layui-input"></div>
    </div>
    <!-- 商品详情 -->
