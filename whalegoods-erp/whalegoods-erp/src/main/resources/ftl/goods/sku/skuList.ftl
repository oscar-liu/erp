  ...
  layui.use('table', function () {
    ...
    table.render({
      ...
      cols: [[
        ...
        {field: 'boxNum', title: '箱包装数', align:'center'},
        {field: 'oneCost', title: '单个成本价', align:'center'},
        {field: 'boxCost', title: '单箱成本价', align:'center'},
        {field: 'marketPrice', title: '建议零售价', align:'center'},
        {field: 'profit', title: '利润率', align:'center'},
