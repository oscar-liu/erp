  ...
  layui.use('table', function () {
    ...
    table.render({
      ...
      cols: [[
        ...
        {field: 'inDate', title: '入库日期', align:'center'},
        {field: 'goodsName', title: '商品名称', align:'center',width:165},
        {field: 'goodsCode',title: '商品编号',align:'center',width:165},
        {field: 'inDate',title: '生产日期',align:'center',width:145},
        {field: 'expiringDate',title: '到期日期',align:'center',width:145},
        {field: 'costPrice', title: '成本价', align:'center',width:60},
        {field: 'marketPrice', title: '建议零售价', align:'center',width:60},
        {field: 'inCount', title: '入库数量', align:'center',width:60},
    ...
    var $ = layui.$, active = {
      ...
      add: function () {
        add('商品入库', 'showAddGoodsStorageIn', 800, 500);
      }
    };
