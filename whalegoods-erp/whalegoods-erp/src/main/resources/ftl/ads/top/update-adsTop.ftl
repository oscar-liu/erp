...
<div class="x-body">
  <form class="layui-form layui-form-pane" style="margin: 20px;">
     <input value="${adsTop.id}" type="hidden" name="id">
     <input value="${adsTop.deviceId}" type="hidden" name="deviceId">
    ...
    <div class="layui-upload-drag" style="margin-left:10%;" id="upBigPic">
     ...
     <p style="font-size: 10px">点击上传，或将文件拖拽到此处</p>     
      ...
      <div class="layui-input-inline">
      <input type="hidden" id="hidBigPicUrl" name="bigPicUrl" value="${adsTop.bigPicUrl}" />
          <div  id="upBigPicNow" style="margin-top: 20px;margin-left: 50px">
            <img src="${adsTop.bigPicUrl}" width="100px" height="100px" class="layui-upload-img" >
          </div>
    ...
    <div class="layui-upload-drag" style="margin-left:10%;" id="upTinyPic">
     ...
     <p style="font-size: 10px">点击上传，或将文件拖拽到此处</p>     
      ...
      <div class="layui-input-inline">
      <input type="hidden" id="hidTinyPicUrl" name="tinyPicUrl" value="${adsTop.tinyPicUrl}" />
          <div  id="upTinyPicNow" style="margin-top: 20px;margin-left: 50px">
            <img src="${adsTop.tinyPicUrl}" width="100px" height="100px" class="layui-upload-img" >
          </div>
...
<script>
  ...
  $(function(){
		 ...
		 $("#select2-sltActionType-container").text($("#sltActionType").find("option[value = "+'${adsTop.actionType}'+"]").text());
		 $('#sltActionType').val('${adsTop.actionType}');
		 
		 if($('#sltActionType').val()==1){
			 $('#divGoodsCode').hide();
		 }
		 if($('#sltActionType').val()==2){
			 $("#select2-sltGoodsCode-container").text($("#sltGoodsCode").find("option[value = "+'${adsTop.goodsCode}'+"]").text());
			 $('#sltGoodsCode').val('${adsTop.goodsCode}');
			 $('#divGoodsCode').show();
		 }
